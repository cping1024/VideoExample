...
#ifndef DEBUG(pLogger, event)
#define LOG_TRACE(pLogger, event)
#define LOG_DEBUG(pLogger, event)
#define LOG_INFO(pLogger, event)
#define LOG_WARN(pLogger, event)
#define LOG_ERROR(pLogger, event)
#else
